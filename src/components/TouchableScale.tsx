...
const TouchableScale = ({onPress, pressInDuration = 150, pressOutDuration = 150, scaleTo = 0.98, pressInEasing = Easing.elastic(1.5), pressOutEasing = Easing.elastic(1.5), style, children}: Props) => {
